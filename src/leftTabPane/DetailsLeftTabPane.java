...
public class DetailsLeftTabPane {

	DetailsData info=null;
	public DetailsLeftTabPane(){
	}

	public DetailsLeftTabPane(DetailsData data){
		info=data;
	}
	...
	public GridPane getDetails()throws IOException,NullPointerException{
		...
		detailsGrid.getChildren().addAll(companyName,companyNameInfo,companySymbol,companySymbolInfo,
										...
										companyOpen,companyOpenInfo,companyDayl,companyDaylInfo,companyDayh,companyDayhInfo,companyClose,companyCloseInfo,
										companyVolume,companyVolumeInfo,companyVolumeA,companyVolumeAInfo,companyStats,companyBVPS,
										companyBVPSInfo,companyRevenue,companyRevenueInfo,companyEBITDA,companyEBITDAInfo,companyOutstandingShares,companyOutstandingSharesInfo,
										companyMarketCap,companyMarketCapInfo);
		return detailsGrid;
