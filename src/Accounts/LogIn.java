...
public class LogIn {
	...
	public static HashMap<String, SymbolsData> mapData;
	...
	private String getExchange(String exchangeFromDB){
		...
		case "FRANKFURT":return exchange="DeCompanies.csv";
		//case "FRANKFURT":return exchange="FrankfurtStockExchange.csv";
		case "NYSE,NASDAQ":return exchange="NYSE,NASDAQ.csv";
		}

		return exchange;
	}
	private void initData(String exchange){
		mapData = new HashMap<String, SymbolsData>();
		try {
				BufferedReader br = getCompanies(exchange);
				String line = br.readLine();
		        while (line != null) {
		            String[] data = line.split(",");
		            mapData.put(data[1], new SymbolsData(data[0]));
		            line = br.readLine();
		        }
		        keys=mapData.keySet();
		} catch (IOException e) {
